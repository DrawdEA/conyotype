...
export type Msg = readonly [who: string, text: string];
...
export const SCENARIOS: Scenario[] = [
  {
    opener: [
      ["Migs", "guys where are we eating, im so gutom"],
      ["Bea", "not jsec again please"],
    ],
    turns: [
      { you: "lets make tambay in katip, so many choices", gloss: "let's hang out in Katipunan", reply: ["Migs", "g, which one"] },
      { you: "samgyup? i can make libre if you make sabay", gloss: "Korean BBQ? my treat if you come along", reply: ["Bea", "omg libre, say less"] },
      { you: "wait kuya can make sundo us at gate three", gloss: "our driver can pick us up at Gate 3", reply: ["Iñigo", "sakay ako pls"] },
      { you: "dont be late, my driver gets so badtrip", gloss: "don't be late, my driver gets annoyed", reply: ["Migs", "5 mins lang promise"] },
      { you: "bring cash, that place is so kuripot with cards", gloss: "that place doesn't take cards", reply: ["Bea", "noted!!"] },
      { you: "after that iced oat latte in rockwell please", gloss: "coffee run at Power Plant after", reply: ["Iñigo", "youre so tita"] },
  ...
  },
  {
    opener: [
      ...
      ["Kyle", "the site is so dead, cannot even load"],
    ],
    turns: [
      { you: "omg the slots are gone, i literally cannot", gloss: "the class slots are all taken", reply: ["Cheska", "same!!! so hassle"] },
      { you: "i need that eight am or my sched is so gulo", gloss: "or my schedule is chaotic", reply: ["Kyle", "eight am? youre insane"] },
      { you: "the prof for the other section is so terror", gloss: "the other professor is strict", reply: ["Cheska", "true, i made iyak last sem"] },
      { you: "can you make refresh for me, my wifi is so slow", gloss: "please refresh the page for me", reply: ["Kyle", "refreshing pray for us"] },
  ...
  },
  {
    opener: [
      ...
      ["Tin", "and paolo has not sent chapter two"],
    ],
    turns: [
      { you: "hes so pabigat, i cant even with him", gloss: "he's dead weight", reply: ["Sab", "literally carrying the group"] },
      { you: "i made chika with him, he said hes making habol", gloss: "I talked to him, he says he's catching up", reply: ["Tin", "making habol since july lol"] },
      { you: "lets make meet at the org room after class", gloss: "let's meet at the org room", reply: ["Sab", "g, ill bring my laptop"] },
      { you: "make pila for the printer, its always so long", gloss: "line up for the printer early", reply: ["Tin", "the pila is insane today"] },
      { you: "if we make puyat tonight we can finish this", gloss: "if we stay up late we can finish", reply: ["Sab", "puyat gang rise up"] },
      { you: "my qpi cannot take another bad grade, please", gloss: "my grade average can't take another hit", reply: ["Tin", "same, dont tell my dad"] },
      { you: "ok lets go, one big fight guys", gloss: "let's do this, the Ateneo cheer", reply: ["Sab", "one big fight!!"] },
    ],
  },
  {
    opener: [
      ["Andrea", "tagaytay this weekend??"],
      ["Marco", "my tita has a rest house in tali also"],
    ],
    turns: [
      { you: "wait is there wifi at the rest house in tali", gloss: "does the beach house have wifi", reply: ["Marco", "yes but so slow"] },
      { you: "its so lamig in tagaytay, i should bring my north face", gloss: "it's cold in Tagaytay", reply: ["Andrea", "bring the puffer"] },
      { you: "can we make stop at bulalo first, im so gutom", gloss: "can we stop for bulalo soup first", reply: ["Marco", "obviously"] },
      { you: "who is driving, my driver is off on weekends", gloss: "my driver doesn't work weekends", reply: ["Andrea", "kuya can, my dad said ok"] },
  ...
  },
  {
    ...
    turns: [
      { you: "im stuck in edsa, the traffic is so sayang of my time", gloss: "EDSA traffic is wasting my time", reply: ["Bea", "always edsa with you"] },
      { you: "my driver is late again, so badtrip", gloss: "my driver was late again", reply: ["Migs", "get a grab next time"] },
  ...
  },
  {
    ...
    turns: [
      ...
      { you: "taft is so far though, can we make kita in rockwell", gloss: "let's meet in Rockwell instead", reply: ["Cheska", "rockwell then moa"] },
      { you: "wear blue, dont be so baduy with the green", gloss: "wear blue, the green is tacky", reply: ["Kyle", "animo la salle jk"] },
      { you: "dude pare chong, thats so jologs of you", gloss: "bro bro bro, that's so tacky", reply: ["Cheska", "hahaha kyle is so hambog"] },
      { you: "my kilig if we win, i will literally die", gloss: "I'll be so thrilled if we win", reply: ["Kyle", "one big fight"] },
  ...
  },
  {
    opener: [
      ...
      ["Paolo", "the tambay in the org room is so gulo rn"],
    ],
    turns: [
      { you: "i made habol my requirements, so stressed", gloss: "I caught up on my requirements", reply: ["Sab", "same, deadz"] },
      { you: "the seniors are making chika about the applicants", gloss: "the seniors are gossiping about applicants", reply: ["Paolo", "so plastic of them"] },
      { you: "dont mind them, they were so hambog last year", gloss: "they were arrogant last year", reply: ["Sab", "true true"] },
      { you: "lets make sabay for the interview, im so kaba", gloss: "let's go together, I'm nervous", reply: ["Paolo", "kaba but cute"] },
      { you: "if i get in, iced oat latte for everyone", gloss: "coffee on me if I get in", reply: ["Sab", "manifesting"] },
  ...
  },
  {
    opener: [
      ...
      ["Iñigo", "he said no gifts but like"],
    ],
    turns: [
      ...
      { you: "make sure bea comes, she is always so late", gloss: "make sure Bea comes on time", reply: ["Marco", "ill make sundo her"] },
  ...
  },
  {
    opener: [
      ...
      ["Paolo", "taft is a river already"],
    ],
    turns: [
      { you: "no announcement yet, the admin is so slow", gloss: "no suspension announcement yet", reply: ["Bea", "so hassle"] },
      ...
      { you: "the aircon in the mrt is so not working also", gloss: "the MRT aircon is broken too", reply: ["Bea", "sauna on rails"] },
      { you: "lets just make stay at the condo and order", gloss: "let's stay in and order food", reply: ["Paolo", "milk tea please"] },
      { you: "wait it got suspended, i literally cannot", gloss: "classes just got suspended", reply: ["Bea", "FINALLY"] },
      { you: "sembreak came early, mom said we can go to japan", gloss: "early break, family trip to Japan", reply: ["Paolo", "youre so rich its annoying"] },
      { you: "dont be asar, ill bring you pasalubong", gloss: "don't be annoyed, I'll bring you souvenirs", reply: ["Bea", "kitkat matcha pls"] },
    ],
  },
  // --- batch 2: freedom-wall flavored + gap topics ---
  {
    opener: [
      ["Enzo", "lf extra grad ticket, anyone??"],
      ["Bianca", "same, my lola wants to come"],
    ],
    turns: [
      { you: "wala pa dates but im looking na din", gloss: "no dates yet but I'm already looking", reply: ["Enzo", "willing to pay kahit magkano"] },
      { you: "dont be oa, its just one ticket", gloss: "don't overreact, it's one ticket", reply: ["Bianca", "one ticket for lola is not oa"] },
      { you: "ask the org room, someone always has extra", gloss: "someone in the org always has a spare", reply: ["Enzo", "g, ill make tanong"] },
      ...
      { you: "ill make send you the seat number tonight", gloss: "I'll send the seat number tonight", reply: ["Enzo", "wait what about me"] },
      { you: "enzo make hanap your own, im out of tickets", gloss: "Enzo, find your own", reply: ["Enzo", "betrayed by my own gc"] },
    ],
  },
  {
    opener: [
      ["Sab", "guys i lost my phone in the caf"],
      ["Tin", "wait when?? did you make hanap na"],
    ],
    turns: [
      { you: "i checked everywhere, its literally gone", gloss: "I searched everywhere", reply: ["Sab", "was it the blue one"] },
      { you: "yes and it was from my ninang, so sentimental", gloss: "my godmother gave it to me", reply: ["Tin", "post on the freedom wall"] },
      { you: "ok posting, ill pay whoever finds it", gloss: "I'll pay a finder's fee", reply: ["Sab", "dont say the amount lol"] },
      { you: "the guard said make check the lost and found", gloss: "check lost and found", reply: ["Tin", "at the lobby, ground floor"] },
      { you: "if wala, my dad is going to make sermon", gloss: "if it's not there, my dad will lecture me", reply: ["Sab", "praying for you bestie"] },
      { you: "wait someone commented, they found it at the lib", gloss: "someone found it at the library", reply: ["Tin", "OMG go get it"] },
      { you: "running now, ill make libre the finder a coffee", gloss: "coffee for the finder", reply: ["Sab", "the wall works, legit"] },
    ],
  },
  {
    opener: [
      ["Kyle", "someone left boxers in the udn bathroom"],
    ...
    turns: [
      ...
      { you: "the janitor is so tired of us honestly", gloss: "the janitor is tired of us", reply: ["Cheska", "kuya deserves a raise"] },
      { you: "post it on the wall, someone will make claim", gloss: "post it, someone will claim it", reply: ["Kyle", "with a pic? no thanks"] },
      { you: "no pic please, i cant with this batch", gloss: "no photo, I can't with this batch", reply: ["Cheska", "the freshies are feral"] },
  ...
  {
    opener: [
      ["Andrea", "is chagee really that good"],
      ["Marco", "or is it just the pretty cups"],
    ],
    turns: [
      { you: "its good if you want the tea part of milk tea", gloss: "good if you like actual tea", reply: ["Andrea", "so its for titas"] },
      { you: "im so tita for it, dont judge me", gloss: "I'm an auntie about it", reply: ["Marco", "we been knew"] },
      { you: "the line in katip is so long though", gloss: "the Katipunan line is long", reply: ["Andrea", "grab it na lang"] },
      ...
      { you: "ok got them, make bayad me later, no gcash excuses", gloss: "pay me later, no excuses", reply: ["Andrea", "sending now, ily"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      { you: "it would be so fun, like tita energy", gloss: "fun, auntie energy", reply: ["Paolo", "prizes should be gcash"] },
      { you: "our org can host, ill make pitch to the exec", gloss: "I'll pitch it to the officers", reply: ["Bea", "you? pitching? ok"] },
      { you: "dont be plastic, i can make effort", gloss: "don't be fake, I can try", reply: ["Paolo", "we believe in you jk"] },
      { you: "venue at the org room, snacks from the caf", gloss: "org room venue, cafeteria snacks", reply: ["Bea", "bring the lolas"] },
      { you: "if my lola comes she is winning, legit", gloss: "if my grandma comes she'll win", reply: ["Paolo", "lola is a bingo shark"] },
      { you: "the exec said yes, friday at the org room", gloss: "the officers said yes, Friday", reply: ["Bea", "THE GC DID SOMETHING"] },
      { you: "make invite everyone, prizes are gcash and snacks", gloss: "invite everyone", reply: ["Paolo", "lola is coming, be warned"] },
    ],
  },
  {
    opener: [
      ["Migs", "the wall posted a crush letter for someone in chemsoc"],
      ["Iñigo", "since term 1 daw, so cute"],
    ],
    turns: [
      { you: "sana ako na lang, like legit", gloss: "I wish it were me", reply: ["Migs", "you have a jowa"] },
      { you: "i know but the kilig is free", gloss: "the butterflies are free", reply: ["Iñigo", "sana all may secret admirer"] },
      { you: "who do you think wrote it, so mysterious", gloss: "who wrote it?", reply: ["Migs", "someone from id124 for sure"] },
      { you: "the vc has a gf though, so awkward", gloss: "the vice chair has a girlfriend", reply: ["Iñigo", "sad ending in advance"] },
      { you: "make send them directly, not the whole campus", gloss: "message them, not the whole campus", reply: ["Migs", "freedom wall said the same"] },
      { you: "update, the vc saw it and made post a heart", gloss: "the vice chair reacted with a heart", reply: ["I\u00f1igo", "plot twist"] },
      { you: "omg the gf saw it too, this is so gulo", gloss: "the girlfriend saw it, chaos", reply: ["Migs", "grab the popcorn"] },
    ],
  },
  {
    opener: [
      ["Tin", "to the annoying guy calling me minion"],
      ["Sab", "he called you tanda too??"],
    ],
    turns: [
      { you: "im only twenty three, hes literally one year younger", gloss: "I'm 23, he's a year younger", reply: ["Tin", "lagot siya sayo"] },
      ...
      { you: "no, well, maybe, dont make chika this", gloss: "maybe, don't gossip about it", reply: ["Tin", "too late its in the gc"] },
  ...
  {
    opener: [
      ["Cheska", "wtf is the dept doing this break"],
    ...
    turns: [
      ...
      { you: "lets make email the chair, all of us", gloss: "let's all email the department chair", reply: ["Cheska", "cc the dean, why not"] },
      { you: "dont cc the dean, thats so oa", gloss: "don't cc the dean, too much", reply: ["Kyle", "oa works though"] },
      { you: "fine, cc everyone, i literally cannot anymore", gloss: "fine, cc everyone", reply: ["Cheska", "sending it now"] },
      { you: "they replied in ten minutes, the dean works", gloss: "cc'ing the dean worked", reply: ["Kyle", "oa wins again"] },
  ...
  },
  {
    opener: [
      ...
      ["Andrea", "somewhere near taft pls"],
    ],
    turns: [
      { you: "theres a salon behind the caf, so underrated", gloss: "underrated salon behind the cafeteria", reply: ["Bianca", "name pls"] },
      { you: "i forgot the name, its beside the milk tea place", gloss: "next to the milk tea shop", reply: ["Andrea", "thats every salon in taft"] },
      { you: "book early, everyone is making grad pic this week", gloss: "everyone's taking grad photos", reply: ["Bianca", "so hassle"] },
      { you: "my tita has a stylist in makati if you want", gloss: "my aunt's stylist is in Makati", reply: ["Andrea", "makati is so far"] },
  ...
  {
    opener: [
      ["Marco", "wala na yosi buddy ko, he graduated"],
      ["Paolo", "lf kapalit basically"],
    ],
    turns: [
      { you: "you should quit, its so bad for you", gloss: "you should quit smoking", reply: ["Marco", "ok tita"] },
      { you: "im serious, my lolo had the cough for years", gloss: "my grandpa had that cough for years", reply: ["Paolo", "wow guilt trip"] },
      { you: "ill be your walking buddy instead, free", gloss: "I'll walk with you instead", reply: ["Marco", "walk where, edsa?"] },
      ...
      { you: "same time tomorrow, no yosi, coffee only", gloss: "same time tomorrow", reply: ["Paolo", "we love a wellness arc"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      { you: "same, i made tulog the whole weekend", gloss: "I slept all weekend", reply: ["Kyle", "self care daw"] },
      { you: "lets make review at the lib, second floor", gloss: "study at the library, 2nd floor", reply: ["Cheska", "the one with the massage chairs?"] },
      { you: "they removed the massage chairs, so sad", gloss: "they took out the massage chairs", reply: ["Kyle", "why cant we have nice things"] },
      { you: "bring coffee, im going to make puyat tonight", gloss: "I'm pulling an all-nighter", reply: ["Cheska", "puyat squad"] },
  ...
  },
  {
    ...
    turns: [
      { you: "i wrote my name and made pray", gloss: "I wrote my name and prayed", reply: ["Sab", "same, thoughts and prayers"] },
      ...
      { you: "the prof wrote lucky on my paper, so shady", gloss: "the prof wrote lucky on it", reply: ["Tin", "iconic honestly"] },
    ],
  },
  {
    opener: [
      ["Bea", "guys im shifting to comm"],
    ...
    turns: [
      ...
      { you: "my dad is so not happy, he wanted an engineer", gloss: "my dad wanted an engineer", reply: ["Migs", "tell him comm makes money"] },
      ...
      { you: "lets celebrate, samgyup, my treat", gloss: "Korean BBQ, my treat", reply: ["Bea", "shifting party!!"] },
      { you: "my dad texted, he said make sure youre happy", gloss: "dad says make sure you're happy", reply: ["Migs", "wait thats so sweet"] },
      { you: "i made iyak again but the good kind this time", gloss: "happy tears this time", reply: ["Bea", "growth era"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      { you: "its in tagaytay so at least its so lamig", gloss: "it's cold in Tagaytay", reply: ["Iñigo", "bring the north face"] },
      ...
      { you: "i do not cry, i make reflect quietly", gloss: "I reflect quietly", reply: ["Iñigo", "sure jan"] },
      { you: "who is our facilitator, sana not the terror one", gloss: "hopefully not the strict facilitator", reply: ["Cheska", "its him. its always him"] },
      { you: "ok make pack the tissue, for reflecting", gloss: "pack tissues, for reflecting", reply: ["Iñigo", "for reflecting HAHAHA"] },
  ...
  {
    opener: [
      ["Marco", "poblacion friday??"],
      ["Andrea", "who is driving, not me"],
    ],
    turns: [
      { you: "ill bring my driver, he can make wait", gloss: "my driver can wait for us", reply: ["Marco", "kuya is a saint"] },
      { you: "dress code is so strict there, no slides", gloss: "no slippers allowed", reply: ["Andrea", "bea wear shoes pls"] },
      { you: "last time bea made sabit on the bouncer", gloss: "Bea hung on the bouncer last time", reply: ["Marco", "she was so kilig"] },
      { you: "curfew is one, my mom will make text every hour", gloss: "curfew at 1, mom texts hourly", reply: ["Andrea", "tell her youre at my condo"] },
  ...
  {
    opener: [
      ["Paolo", "guys i forgot my wallet at the org room"],
    ...
    turns: [
      ...
      { you: "im so hungry, this is literally survival", gloss: "I'm starving", reply: ["Paolo", "fine, one siomai rice"] },
      { you: "make add iced tea, im so thirsty also", gloss: "add an iced tea too", reply: ["Kyle", "you are so kapal"] },
  ...
  {
    opener: [
      ["Bianca", "siargao sembreak, who is in"],
      ["Sab", "flights are so mahal now"],
    ],
    turns: [
      { you: "book now, my tita said it gets worse", gloss: "book now, it gets pricier", reply: ["Bianca", "tita knows"] },
      ...
      { you: "my mom said make text every night or she flies there", gloss: "mom wants nightly texts", reply: ["Bianca", "tita on standby"] },
    ],
  },
  {
    opener: [
      ["Migs", "naia is a mess rn"],
      ["Tin", "flight delayed three hours, so hassle"],
    ],
    turns: [
      { you: "make eat at the lounge, my dad has a card", gloss: "eat at the lounge on my dad's card", reply: ["Migs", "the card saves us again"] },
      ...
      { you: "japan better be worth this, legit", gloss: "Japan had better be worth it", reply: ["Tin", "the matcha alone is worth it"] },
      { you: "buy me the kitkat matcha or dont come back", gloss: "get me matcha KitKats", reply: ["Migs", "noted, tita"] },
      { you: "boarding finally, my legs are so tired from waiting", gloss: "finally boarding", reply: ["Tin", "sleep on the plane"] },
      { you: "i cant sleep in economy, the seat is so sakit", gloss: "economy seats hurt", reply: ["Migs", "the card cant fix everything"] },
    ],
  },
  {
    opener: [
      ["Cheska", "so is it a situationship or"],
      ["Andrea", "define the relationship na, girl"],
    ],
    turns: [
      { you: "he said hes not ready, so what am i", gloss: "he's not ready, so what am I?", reply: ["Cheska", "a placeholder, sorry"] },
      { you: "dont say that, i was so kilig last week", gloss: "I was so giddy last week", reply: ["Andrea", "kilig is not commitment"] },
      ...
      { you: "if he ghosts me im so done, like literally", gloss: "if he ghosts me I'm done", reply: ["Cheska", "we will make block him"] },
      { you: "update, he said lets be exclusive, im shaking", gloss: "he said exclusive", reply: ["Cheska", "WAIT I NEED A SECOND"] },
      { you: "dont make chika yet, i want to enjoy it first", gloss: "don't gossip yet", reply: ["Andrea", "too late, telling bea"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      ...
      { you: "should i say hi or make deadma", gloss: "say hi or ignore him?", reply: ["Kyle", "deadma. always deadma"] },
      ...
      { you: "i made reply thanks, one word, so cold, so proud", gloss: "one-word reply", reply: ["Marco", "ice queen unlocked"] },
    ],
  },
  {
    opener: [
      ["Bea", "hard launch on ig today"],
      ["Sab", "FINALLY. show us"],
    ],
    turns: [
      { you: "posting the beach pic with him, no caption", gloss: "beach photo, no caption", reply: ["Bea", "no caption is a caption"] },
      { you: "my tita will comment in five minutes, watch", gloss: "my aunt will comment instantly", reply: ["Sab", "tita has notifications on"] },
      { you: "she already asked if hes catholic, so fast", gloss: "she already asked if he's Catholic", reply: ["Bea", "HAHAHA classic"] },
      { you: "his friends are so hambog in the comments", gloss: "his friends are cocky in the comments", reply: ["Sab", "boys are so plastic"] },
      { you: "whatever, im so happy, make like it na", gloss: "I'm happy, just like the post", reply: ["Bea", "liked, commented, shared"] },
      { you: "two hundred likes and my lola commented amen", gloss: "my grandma commented amen", reply: ["Bea", "lola approves"] },
      { you: "his mom followed me, this is moving so fast", gloss: "his mom followed me", reply: ["Sab", "meet the parents next"] },
    ],
  },
  {
    opener: [
      ["Iñigo", "noche buena at lola's, mandatory"],
      ["Paolo", "the tita questions are coming"],
    ],
    turns: [
      ...
      { you: "the lechon is worth it though, so sarap", gloss: "the roast pig is worth it", reply: ["Iñigo", "for the lechon we suffer"] },
      ...
      { you: "the lechon was so sarap though, worth every question", gloss: "the roast pig was worth it", reply: ["I\u00f1igo", "lechon heals all"] },
    ],
  },
  {
    opener: [
      ["Andrea", "my driver quit"],
      ["Tin", "kuya?? after ten years??"],
    ],
    turns: [
      { you: "hes going to dubai, more money daw", gloss: "he's moving to Dubai for better pay", reply: ["Andrea", "deserve, honestly"] },
      { you: "now i have to make commute, i dont know the mrt", gloss: "now I have to commute", reply: ["Tin", "the mrt is not that hard"] },
      { you: "which line goes to taft, like genuinely", gloss: "which line goes to Taft?", reply: ["Andrea", "youre so sheltered omg"] },
      { you: "i can make grab but the surge is so mahal", gloss: "Grab surge pricing is expensive", reply: ["Tin", "welcome to our life"] },
      { you: "ok teach me, ill make libre your fare", gloss: "teach me, I'll pay your fare", reply: ["Andrea", "beep card first, bestie"] },
      { you: "i survived the mrt, so proud, only two wrong stations", gloss: "I survived, only two wrong stops", reply: ["Andrea", "two?? how"] },
      { you: "they all look the same, dont make judge me", gloss: "they look the same", reply: ["Tin", "youre so sheltered, i love it"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      ...
      { you: "she told tita, so the whole clan knows", gloss: "she told my aunt, everyone knows", reply: ["Kyle", "family gc is wild"] },
      ...
      { you: "i told her lola has one too, she went quiet", gloss: "grandma has one too", reply: ["Migs", "lola with a tattoo?? icon"] },
    ],
  },
  {
    opener: [
    ...
    turns: [
      ...
      { you: "lets make gcash the birthday girl and shes done", gloss: "send the birthday girl money and be done", reply: ["Bianca", "fair, ill make send now"] },
      { you: "next time we eat at the caf, no wagyu", gloss: "next time cafeteria, no wagyu", reply: ["Sab", "caf gang"] },
  ...
  },
  {
    opener: [
      ...
      ["Paolo", "corporate na si cheska, omg"],
    ],
    turns: [
      ...
      { you: "i have to make commute to bgc by eight", gloss: "commute to BGC by 8 AM", reply: ["Cheska", "leave at six, im serious"] },
      { you: "six?? thats so early, i will make tulog standing", gloss: "I'll sleep standing up", reply: ["Paolo", "corporate life bestie"] },
  ...
  },
  {
    ...
    turns: [
      ...
      { you: "he made tag everyone, even the guard", gloss: "he tagged everyone", reply: ["Bea", "the guard deserves it tbh"] },
      { you: "im so not posting mine, its just an internship", gloss: "I'm not posting mine", reply: ["Marco", "post it, its for tita"] },
      ...
      { you: "posted, tita shared it in two minutes flat", gloss: "aunt shared it instantly", reply: ["Bea", "tita has a bot"] },
      { you: "now my lolo wants to know what an intern is", gloss: "grandpa asked what an intern is", reply: ["Marco", "explain slowly"] },
    ],
  },
  {
    opener: [
      ["Tin", "guys my tiktok went viral"],
      ["Iñigo", "the one in the caf?? it has 200k"],
    ],
    turns: [
      ...
      { you: "my prof saw it and made comment, so awkward", gloss: "my professor commented on it", reply: ["Tin", "which prof??"] },
      { you: "the terror one, he said nice video, i died", gloss: "the strict prof said nice video", reply: ["Iñigo", "hes a fan now"] },
      ...
      { you: "a brand messaged me, do i make reply, so scared", gloss: "a brand reached out", reply: ["I\u00f1igo", "REPLY. free milk tea"] },
    ],
  },
  {
    opener: [
      ["Paolo", "mrt broke down again"],
      ["Andrea", "stuck between stations, so init"],
    ],
    turns: [
      { you: "the aircon is so not working, im melting", gloss: "the aircon is broken", reply: ["Paolo", "sauna on rails"] },
      { you: "im going to be late, tell the prof i made faint", gloss: "tell the prof I fainted", reply: ["Andrea", "he wont believe that"] },
      { you: "grab surge is triple, so not worth it", gloss: "Grab is triple price", reply: ["Paolo", "walk from taft station lol"] },
      ...
      { you: "he said class is cancelled, the heels were for nothing", gloss: "class got cancelled", reply: ["Andrea", "sayang the heels"] },
    ],
  },
  {
    opener: [
      ["Kyle", "pickleball saturday, who is in"],
      ["Bianca", "isnt that a tita sport"],
    ],
    turns: [
      { you: "its so fun though, my tito plays every day", gloss: "my uncle plays daily", reply: ["Kyle", "tito energy is the goal"] },
      ...
      { you: "brunch after, i am so hungry i could make eat the paddle", gloss: "so hungry", reply: ["Bianca", "salcedo, go go"] },
    ],
  },
  {
    opener: [
      ["Bea", "brownout in the condo since noon"],
      ["Sab", "same, no wifi, no aircon, so init"],
    ],
    turns: [
      { you: "my phone is at ten percent, this is so scary", gloss: "phone at 10%, scary", reply: ["Bea", "go to the caf, they have power"] },
      { you: "the caf is full, everyone had the same idea", gloss: "everyone thought of that", reply: ["Sab", "starbucks in katip?"] },
      ...
      { you: "the deadline is tonight and i cant even submit", gloss: "deadline tonight, can't submit", reply: ["Sab", "email the prof from your phone"] },
